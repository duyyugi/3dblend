...
let activeAction;
let lastAction;
let ChoosenAnimationActions = new Array();
...
fbxLoader.load('models/vanguard_t_choonyung.fbx', (object) => {
    ...
    fbxLoader.load('models/vanguard@petting.fbx', (object) => {
        console.log("loaded petting");
        let animationAction = mixer.clipAction(object.animations[0]);
        animationActions.push(animationAction);
        animationsFolder.add(animations, "petting");
        //add an animation from another file
        fbxLoader.load('models/vanguard@angry.fbx', (object) => {
            console.log("loaded angry");
            let animationAction = mixer.clipAction(object.animations[0]);
            animationActions.push(animationAction);
            animationsFolder.add(animations, "angry");
            //add an animation from another file
            fbxLoader.load('models/vanguard@hiphop.fbx', (object) => {
